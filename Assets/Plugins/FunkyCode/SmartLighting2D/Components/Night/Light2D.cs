...
using UnityEngine;
using Object = FunkyCode.SmartLighting2D.Scripts.Event_Handling.Object;
...
namespace FunkyCode
{
	...
	public class Light2D : LightingMonoBehaviour
	{
		...
		public LightBuffer2D GetBuffer()
		{
			if (buffer == null)
			{
				buffer = Manager.PullBuffer (this);
			}
