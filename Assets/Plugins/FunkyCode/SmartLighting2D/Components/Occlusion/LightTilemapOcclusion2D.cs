...
using FunkyCode.SmartLighting2D.Scripts.Components.LightOcclusion2D;
using FunkyCode.SmartLighting2D.Scripts.Components.LightTilemapOcclusion;
using FunkyCode.SmartLighting2D.Scripts.Settings;
using SortingLayer = FunkyCode.SmartLighting2D.Scripts.Settings.SortingLayer;
