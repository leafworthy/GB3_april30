...
namespace FunkyCode.SmartLighting2D.Scripts.Editor.Settings
{
		...
		public class QualitySettings
		{
			public static void Draw(Profile profile)
			{
				...
				EditorGUI.indentLevel++;
					...
					profile.qualitySettings.lightTextureSize = (LightingSourceTextureSize)EditorGUILayout.Popup("Light Resolution", (int)profile.qualitySettings.lightTextureSize, Scripts.Settings.QualitySettings.LightingSourceTextureSizeArray);
					
					profile.qualitySettings.lightEffectTextureSize = (LightingSourceTextureSize)EditorGUILayout.Popup("Translucent Resolution", (int)profile.qualitySettings.lightEffectTextureSize, Scripts.Settings.QualitySettings.LightingSourceTextureSizeArray);
