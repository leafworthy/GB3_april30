...
using FunkyCode.SmartLighting2D.Scripts.Rendering.Light.ShadowEngine.Algorithm;
using FunkyCode.SmartLighting2D.Scripts.Settings;
using FunkyCode.Utilities;
using UnityEngine;

namespace FunkyCode.SmartLighting2D.Scripts.Rendering.Light.ShadowEngine
{
