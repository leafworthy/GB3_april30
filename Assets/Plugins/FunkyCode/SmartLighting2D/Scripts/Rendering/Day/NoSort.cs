using FunkyCode.SmartLighting2D.Scripts.Rendering.Day.Masks;
using FunkyCode.SmartLighting2D.Scripts.Rendering.Day.Shadow;
using FunkyCode.SmartLighting2D.Scripts.Settings;
using UnityEngine;

namespace FunkyCode.SmartLighting2D.Scripts.Rendering.Day
{
