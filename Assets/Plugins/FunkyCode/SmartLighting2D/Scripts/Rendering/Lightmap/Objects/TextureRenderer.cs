...
using UnityEngine;
using Texture = FunkyCode.SmartLighting2D.Scripts.Rendering.Universal.Objects.Texture;

namespace FunkyCode.SmartLighting2D.Scripts.Rendering.Lightmap.Objects
{
