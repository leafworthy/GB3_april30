...
namespace FunkyCode.SmartLighting2D.Scripts.Components.LightOcclusion2D
{
	public class LightingOcclussion
	{
		...
		public LightingOcclussion(LightingOcclusionShape shape, float size) {
			...
			switch(shape.shadowType) {
				case FunkyCode.LightOcclusion2D.ShadowType.Collider:
				...
				case FunkyCode.LightOcclusion2D.ShadowType.SpritePhysicsShape:
