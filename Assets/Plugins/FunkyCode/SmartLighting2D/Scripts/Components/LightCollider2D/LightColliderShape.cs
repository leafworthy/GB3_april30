...
using FunkyCode.SmartLighting2D.Scripts.LightShapes;
...
namespace FunkyCode.SmartLighting2D.Scripts.Components.LightCollider2D
{
	...
	{
		public FunkyCode.LightCollider2D.ShadowType  shadowType = FunkyCode.LightCollider2D.ShadowType.SpritePhysicsShape;
		public FunkyCode.LightCollider2D.MaskType maskType = FunkyCode.LightCollider2D.MaskType.Sprite;
		public FunkyCode.LightCollider2D.MaskPivot maskPivot = FunkyCode.LightCollider2D.MaskPivot.TransformCenter;
		...
		public Base GetShadowShape()
		{
			switch(shadowType)
			{
				case FunkyCode.LightCollider2D.ShadowType.SpritePhysicsShape:
					return(spritePhysicsShape);

				case FunkyCode.LightCollider2D.ShadowType.Collider2D:
					return(collider2DShape);

				case FunkyCode.LightCollider2D.ShadowType.Collider3D:
					return(collider3DShape);

				case FunkyCode.LightCollider2D.ShadowType.CompositeCollider2D:
					return(compositeShape);

				case FunkyCode.LightCollider2D.ShadowType.MeshRenderer:
					return(meshShape);

				case FunkyCode.LightCollider2D.ShadowType.SkinnedMeshRenderer:
		...
		{
			switch(maskType) {
				case FunkyCode.LightCollider2D.MaskType.Sprite:
					return(spriteShape);

				case FunkyCode.LightCollider2D.MaskType.BumpedSprite:
					return(spriteShape);

				case FunkyCode.LightCollider2D.MaskType.SpritePhysicsShape:
					return(spritePhysicsShape);

				case FunkyCode.LightCollider2D.MaskType.CompositeCollider2D:
					return(compositeShape);

				case FunkyCode.LightCollider2D.MaskType.Collider2D:
					return(collider2DShape);
					
				case FunkyCode.LightCollider2D.MaskType.Collider3D:
					return(collider3DShape);

				case FunkyCode.LightCollider2D.MaskType.MeshRenderer:
					return(meshShape);

				case FunkyCode.LightCollider2D.MaskType.BumpedMeshRenderer:
					return(meshShape);

				case FunkyCode.LightCollider2D.MaskType.SkinnedMeshRenderer:
					return(skinnedMeshShape);
			}
		...
		public void SetTransform(FunkyCode.LightCollider2D lightCollider2D)
		{
		...
		public Vector2 GetPivotPoint()
		{
			...
			if (shadowShape != null)
			{
				switch(maskPivot)
				{
					case FunkyCode.LightCollider2D.MaskPivot.TransformCenter:
						return(shadowShape.GetPivotPoint_TransformCenter());

					case FunkyCode.LightCollider2D.MaskPivot.ShapeCenter:
						return(shadowShape.GetPivotPoint_ShapeCenter());

					case FunkyCode.LightCollider2D.MaskPivot.LowestY:
