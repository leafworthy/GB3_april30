...
namespace FunkyCode.SmartLighting2D.Scripts.Components.Light2D
{
	public class LightTransform
	{
		...
		public void Update(FunkyCode.Light2D light)
		{
			...
			{
				case FunkyCode.Light2D.Rotation.Local:

					rotation2D = transform.localRotation.eulerAngles.z;
			
				break;

				case FunkyCode.Light2D.Rotation.World:
