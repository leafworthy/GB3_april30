...
public class Light2DEditor : UnityEditor.Editor {
	...
	SerializedProperty occlusionLayer;
	...
	override public void OnInspectorGUI() {
		...
		light2D.coreSize = EditorGUILayout.Slider("Soft Core Size", light2D.coreSize, 0.1f, 10f);

		light2D.falloff = EditorGUILayout.Slider("Soft Fall Off", light2D.falloff, 0, 10f);
