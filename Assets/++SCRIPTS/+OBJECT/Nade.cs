...
public class Nade:MonoBehaviour  {
	...
	public void Launch(Vector2 _start, Vector2 startingVelocity, float _throwTime, Player _owner)
	{
		...
		jumpVel.y = timeLeft * Game_GlobalVariables.Gravity.y/2;
	...
	private void FixedUpdate()
	{
		...
		Explosions.I.Explode(transform.position, explosionRadius, explosionDamage,owner);
	...
	private void Move()
	{
		...
		jumpVel.y -= Game_GlobalVariables.Gravity.y * Time.fixedDeltaTime;
