...
namespace __SCRIPTS.Plugins.AstarPathfindingProject.Core
{
	[ExecuteInEditMode]
	...
	public static new AstarPath active;
		...
		/// See: <see cref="Heuristic"/> for more details and descriptions of the different modes.
