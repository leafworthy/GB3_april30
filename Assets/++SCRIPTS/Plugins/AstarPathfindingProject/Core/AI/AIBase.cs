using __SCRIPTS.Plugins.AstarPathfindingProject.Behaviors;
...
using __SCRIPTS.Plugins.AstarPathfindingProject.Pathfinders;
using UnityEngine;
...
namespace __SCRIPTS.Plugins.AstarPathfindingProject.Core.AI {
	...
	public abstract class AIBase : VersionedMonoBehaviour {
		...
		///
		/// Deprecated: In 4.1 this will automatically add a <see cref="AIDestinationSetter"/> component and set the target on that component.
