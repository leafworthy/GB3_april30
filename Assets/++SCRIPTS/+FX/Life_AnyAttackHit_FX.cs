...
namespace __SCRIPTS
{
	public class Life_AnyAttackHit_FX : MonoBehaviour
	{
		...
		private void MakeDebree(Attack attack, Life hitLife)
		{
			...
			{
				//----->
				var forwardDebree = ObjectMaker.I.Make(ASSETS.FX.GetDebree(attack.DestinationLife.DebrisType), attack.DestinationFloorPoint);
				...
				var backwardDebree = ObjectMaker.I.Make(ASSETS.FX.GetDebree(attack.DestinationLife.DebrisType), attack.DestinationFloorPoint);
