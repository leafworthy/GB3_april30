...
public class Bullet : MonoBehaviour
{
	...
	public void Fire(Attack attack, Vector2 attackStartPoint)
	{
		...
		sorting.SorterPositionOffset = (Vector2) attack.OriginFloorPoint -(Vector2)transform.position;
		sorting.SorterPositionOffset2 = (Vector2) attack.DestinationFloorPoint - (Vector2)transform.position;
