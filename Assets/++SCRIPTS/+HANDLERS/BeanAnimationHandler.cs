...
public class BeanAnimationHandler : MonoBehaviour, IRecyclable
{
	...
	private void FindAnimators()
	{
		...
		foreach (var animator in animators)
			...
			{
				Debug.Log("init bottom");
				bottomAnimator = animator;
			}
	}
	...
	{
		FindAnimators();
		if (topSpriteRenderer == null) topSpriteRenderer = topAnimator.GetComponent<SpriteRenderer>();
