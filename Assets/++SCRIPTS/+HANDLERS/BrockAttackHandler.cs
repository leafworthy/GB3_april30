...
public class BrockAttackHandler : MonoBehaviour, IPlayerAttackHandler, IAimHandler
{
	...
	private void Anim_AttackHit(int attackType)
	{
		...
		else
		{
			...
			var raycast = Physics2D.CircleCastAll((Vector2) position, SpecialAttackWidth, aimDir, SpecialAttackDistance,
				ASSETS.LevelAssets.EnemyLayer);
			Debug.DrawRay((Vector2)position, (Vector2) aimDir *SpecialAttackDistance, Color.red);
