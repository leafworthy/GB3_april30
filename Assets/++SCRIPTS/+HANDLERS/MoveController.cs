...
public class MoveController : MonoBehaviour
{
	...
	private void Anim_OnStep()
	{
		...
		var dust = Maker.Make(ASSETS.FX.dust1_ground, body.FootPoint.transform.position);
	...
	public Vector2 GetMovePoint()
	{
		...
		return (Vector2) body.AimCenter.transform.position + MoveDir * Aimer.aimDistanceFactor;
	}
