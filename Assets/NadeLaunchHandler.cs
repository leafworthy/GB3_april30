...
public class NadeLaunchHandler:MonoBehaviour, IExplode  {
	...
	public void Launch(Vector2 _start, Vector2 _end, Vector2 startingVelocity, float _throwTime, IAttackHandler _owner)
	{
		owner = _owner;
	...
	private void FixedUpdate()
	{
		...
		jumpObject.transform.localPosition = new Vector3(0, 1, 0);
		isJumping = false;
		OnHitNothing?.Invoke(transform.position, owner);
