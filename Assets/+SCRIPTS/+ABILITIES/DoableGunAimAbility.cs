...
namespace __SCRIPTS
{
	public class DoableGunAimAbility : DoableAimAbility
	{
		...
		public override void SetPlayer(Player _player)
		{
			...
			glockClips.AddMany(Glock_E, Glock_EEN, Glock_EN, Glock_NE, Glock_NW, Glock_WN, Glock_WWN, Glock_W, Glock_WWS, Glock_WS, Glock_SW, Glock_SE,
				Glock_ES, Glock_EES);
