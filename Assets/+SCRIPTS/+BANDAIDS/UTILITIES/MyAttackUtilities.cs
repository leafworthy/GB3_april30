...
using UnityEditor;
	...
	public static class MyAttackUtilities
	{
		...
		{
			var materialTintColor = tintColor;
		...
		static void MakeHitMark(Attack attack, DebrisType debrisType)
		{
		...
		static void CreateDamageRisingText(Attack attack)
		{
		...
		static void SprayDebree(Attack attack, DebrisType debrisType, Color debrisColor)
		{
		...
		static void CreateBloodSpray(Attack attack)
		{
		...
		static void MakeDebree(Attack attack, Vector2 position, DebrisType debrisType, Color debrisColor)
		{
