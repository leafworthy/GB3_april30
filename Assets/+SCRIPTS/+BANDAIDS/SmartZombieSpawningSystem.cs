...
namespace __SCRIPTS
{
    ...
    /// </summary>
    public class SmartZombieSpawningSystem : ServiceUser
    {
        ...
        private void AttemptSpawn()
        {
            ...
            GameObject enemy = objectMaker.Make(enemyPrefab, spawnPosition);
        ...
        private void AttemptBossSpawn()
        {
            ...
            Vector3 spawnPosition = chosenSpawnPoint.transform.position;
            GameObject enemy = objectMaker.Make(bossEnemyPrefab, spawnPosition);
        ...
        private void ConfigureNewEnemy(GameObject enemy, bool isBoss = false)
        {
            ...
            if (life != null)
            {
                life.SetPlayer(playerManager.enemyPlayer);
            ...
            {
                component.SetPlayer(playerManager.enemyPlayer);
            }
