...
namespace SingularityGroup.HotReload
{
	...
	internal static class ThreadUtility
	{
		...
		public static CancellableSwitchToMainThreadAwaitable SwitchToMainThread(CancellationToken token) => new(token);

		public static SwitchToThreadPoolAwaitable SwitchToThreadPool() => new();

		public static CancellableSwitchToThreadPoolAwaitable SwitchToThreadPool(CancellationToken token) => new(token);
	}
	...
	internal struct CancellableSwitchToMainThreadAwaitable
	{
		...
		public CancellableSwitchToMainThreadAwaitable(CancellationToken token) => this.token = token;

		public Awaiter GetAwaiter() => new(token);

		public struct Awaiter : ICriticalNotifyCompletion
		{
			readonly CancellationToken token;
			public Awaiter(CancellationToken token) => this.token = token;
	...
	{
		readonly CancellationToken token;
		public CancellableSwitchToThreadPoolAwaitable(CancellationToken token) => this.token = token;
