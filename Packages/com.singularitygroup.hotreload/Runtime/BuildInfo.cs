...
namespace SingularityGroup.HotReload
{
	...
	internal class BuildInfo
	{
		...
		public static string GetStoredPath() => Path.Combine(Application.streamingAssetsPath, GetStoredName());

		public static string GetStoredName() => "HotReload_BuildInfo.json";
